...
Related Topics}, as a research article.
...
each is proved to return exactly the locus it claims.
...
together, from one ansatz, as components of one constructible set.
...
The third is the pair of algorithms that compute the three loci, together with
...
interests to declare, and the research received no funding.
...
\url{https://doi.org/10.5281/zenodo.22783641} and cited in the reference list.
