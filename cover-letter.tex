...
%   - the Editor-in-Chief's name in the salutation, if you would rather
%     not address the editors collectively;
...
Computational Algebra} for consideration as a Full-Length Research Article.
...
{\bf Fit with the journal's scope.}  Both the mathematics and the algorithms
contribute to the result.  Section~3 develops the theory: specialization of a
